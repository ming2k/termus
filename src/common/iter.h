#ifndef TERMUS_ITER_H
#define TERMUS_ITER_H
...
{
	return iter->data0 != NULL && iter->data1 == NULL &&
	       iter->data2 == NULL;
}
...
static inline int iter_is_empty(struct iter *iter)
{
	return iter->data0 == NULL ||
	       (iter->data1 == NULL && iter->data2 == NULL);
}
...
#define GENERIC_TREE_ITER_PREV(FUNC, TYPE, MEMBER)                             \
	...
	{                                                                      \
		...
		if (e == NULL) {                                               \
			...
			iter->data1 =                                          \
			    container_of(rb_last(root), TYPE, MEMBER);         \
			return 1;                                              \
		}                                                              \
...
#define GENERIC_TREE_ITER_NEXT(FUNC, TYPE, MEMBER)                             \
	...
	{                                                                      \
		...
		if (e == NULL) {                                               \
			...
			iter->data1 =                                          \
			    container_of(rb_first(root), TYPE, MEMBER);        \
			return 1;                                              \
		}                                                              \
