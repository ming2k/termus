...
static pthread_mutex_t worker_mutex = TERMUS_MUTEX_INITIALIZER;
...
#define worker_lock() termus_mutex_lock(&worker_mutex)
#define worker_unlock() termus_mutex_unlock(&worker_mutex)
