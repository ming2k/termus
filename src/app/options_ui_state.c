...
{
	return search_resets_position;
}

int options_get_set_term_title(void)
{
	return set_term_title;
}
...
{
	return pause_on_output_change;
}

int options_get_block_key_paste(void)
{
	return block_key_paste;
}
